...
module.exports = {
  // supported locales
  _locales: ['en', 'ar', 'cz', 'de', 'es', 'fr', 'hu', 'id', 'it', 'ja', 'ko', 'lt', 'nb', 'nl', 'pl', 'pt-BR', 'ru', 'sk', 'sv', 'th', 'zh', 'zh-TW'],
  ...
  $ref: {
    ...
    lt: 'nepavyksta pasiekti nuorodos {{=e.params.ref}}',
  ...
  additionalItems: {
    ...
    lt: '{{#def.n}}negali turėti daugiau kaip {{=n}} element{{#def.mPlural}}',
  ...
  additionalProperties: {
    ...
    lt: 'negali turėti papildomų atributų',
  ...
  anyOf: {
    ...
    lt: 'turi atitikti bent vieną "anyOf" schemą',
  ...
  dependencies: {
    ...
    lt: '{{#def.n}}turi turėti atribut{{#def.propPlural}} {{=e.params.deps}} kai objektas turi {{=e.params.property}} atributą',
    nb: '{{#def.n}}må ha egenskapen{{? n != 1}}e{{?}} {{=e.params.deps}} når egenskapen {{=e.params.property}} er angitt',
    nl: '{{#def.n}}moet eigenschap{{#def.propPlural}} {{=e.params.deps}} hebben als eigenschap {{=e.params.property}} aanwezig is',
  ...
  enum: {
    ...
    lt: 'turi būti bent viena iš duotų reikšmių',
  ...
  format: {
    ...
    lt: 'turi atitikti formatą "{{=e.params.format}}"',
  ...
  maxItems: {
    ...
    lt: '{{#def.n}}negali turėti daugiau negu {{=n}} element{{#def.mPlural}}',
  ...
  minItems: {
    ...
    lt: '{{#def.n}}negali turėti mažiau negu {{=n}} element{{#def.mPlural}}',
  ...
  maxLength: {
    ...
    lt: '{{#def.n}}negali būti būti ilgesnis negu {{=n}} simbol{{? n==1 }}is{{??}}iai{{?}}',
  ...
  minLength: {
    ...
    lt: '{{#def.n}}negali būti būti trumpesnis negu {{=n}} simbol{{? n==1 }}is{{??}}iai{{?}}',
  ...
  maxProperties: {
    ...
    lt: '{{#def.n}}negali turėti daugiau negu {{=n}} atribut{{#def.propPlural}}',
    nb: '{{#def.n}}kan ikke ha mer enn {{=n}} egenskap{{#def.mPlural}}',
    nl: '{{#def.n}}mag niet meer dan {{=n}} eigenschap{{#def.propPlural}} hebben',
  ...
  minProperties: {
    ...
    lt: '{{#def.n}}negali turėti mažiau negu {{=n}} atribut{{#def.propPlural}}',
    nb: '{{#def.n}}kan ikke ha mindre enn {{=n}} egenskap{{#def.mPlural}}',
    nl: '{{#def.n}}mag niet minder dan {{=n}} eigenschap{{#def.propPlural}} hebben',
  ...
  multipleOf: {
    ...
    lt: 'turi būti {{=e.params.multipleOf}} kartotinis',
  ...
  not: {
    ...
    lt: 'negali atitikti "not" schemos',
  ...
  oneOf: {
    ...
    lt: 'turi atitikti lygiai vieną "oneOf" schemą',
  ...
  pattern: {
    ...
    lt: 'turi atitikti išraišką "{{=e.params.pattern}}"',
  ...
  required: {
    ...
    lt: 'turi turėti privalomą atributą {{=e.params.missingProperty}}',
  ...
  uniqueItems: {
    ...
    lt: 'negali turėti vienodų elementų (elementai ## {{=e.params.j}} ir {{=e.params.i}} yra identiški)',
    nb: 'kan ikke ha duplikate elemeneter (elementene ## {{=e.params.j}} og {{=e.params.i}} er identiske)',
    nl: 'mag geen dubbele items bevatten (items ## {{=e.params.j}} en {{=e.params.i}} zijn gelijk)',
  ...
  custom: {
    ...
    lt: 'turi praeiti "{{=e.keyword}}" raktažodžio patikrą',
  ...
  propertyNames: {
    ...
    lt: 'atributo pavadinimas \'{{=e.params.propertyName}}\' yra negaliojantis',
  ...
  patternRequired: {
    ...
    lt: 'turi turėti atributą, kuris atitinkanka išraišką "{{=e.params.missingPattern}}"',
    nb: 'må ha en egenskap som samsvarer med mønsteret "{{=e.params.missingPattern}}',
    nl: 'moet een eigenschap hebben met het volgende patroon "{{=e.params.missingPattern}}"',
  ...
  switch: {
    ...
    lt: 'turi pereiti "switch" patikrą, atvejis {{=e.params.caseIndex}} nepavyksta',
    nb: 'må passere "switch" validering, tilfellet {{=e.params.caseIndex}} misslykkes',
    nl: 'moet "switch" sleutelwoord validatie doorstaan, geval {{=e.params.caseIndex}} gaat verkeerd',
  ...
  contains: {
    ...
    lt: 'privalo turėti galiojantį elementą',
  ...
  formatExclusiveMaximum: {
    ...
    lt: 'formatExclusiveMaximum turi būti boolean',
  ...
  formatExclusiveMinimum: {
    ...
    lt: 'formatExclusiveMinimum turi būti boolean',
  ...
  if: {
    ...
    lt: 'turi atitikti "{{=e.params.failingKeyword}}" schemą',
